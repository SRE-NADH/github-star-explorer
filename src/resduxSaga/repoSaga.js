...
import { fetchReposLoading,fetchReposSuccess,fetchReposRequest } from '../Slices/reposSlice';
import axios from 'axios';



// find date of 30 days before from now 
function findDate(){ // Get the current date
...
function* fetchReposSaga(action){
    ...
    try{
     ...
     let response = yield call(axios.get,`https://api.github.com/search/repositories?q=created:>${findDate()}&sort=stars&order=desc&per_page=10&page=${action.payload}`);
     // update array
